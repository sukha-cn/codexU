...
This branch intentionally registers only the Codex provider. It does not enumerate or parse data under `~/.claude/`, and its isolated test runs against a temporary Codex home and cache directory.
